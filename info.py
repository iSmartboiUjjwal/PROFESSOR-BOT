...
BOT_TOKEN = environ['BOT_TOKEN', '6078735790:AAEC7riyYeYFgCdloKFW2ZoDqPdS9UJ3kMM']
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001695103146')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mxaprofessor:mxaprofessor@mxaprofessor.yg5cwpw.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "mxaprofessor")
...
WELCOM_TEXT = environ.get("WELCOM_TEXT", "Hai {user}\nwelcome to {chat}\nSend any movie name i will provide you links of that movie")
...
SHORT_API = environ.get('SHORT_API', 'a9d93106c79fd6a00f92c026c7c91e4be9ede78e')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Hey {mention}👋\n\n<a href=https://t.me/Movies_X_Animes>{file_name}</a>\n\n🔘 size - {file_size}\n\n╔═════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗\n💥 𝙅𝙊𝙄𝙉 :- @Movies_X_Animes\n💥 𝙅𝙊𝙄𝙉 :- @MxA_Bots\n╚═════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", None)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Query: {query}</b> \n‌IMDb Data:\n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10\n\n\n<b>Join @Movies_X_Animes</b>")
LONG_IMDB_DESCRIPTION = is_enabled(environ.get("LONG_IMDB_DESCRIPTION", "False"), False)
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "True"), True)
MAX_LIST_ELM = environ.get("MAX_LIST_ELM", None)
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '--1001920203328')).split()]
